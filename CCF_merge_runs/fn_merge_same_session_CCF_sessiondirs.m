function [merged_sessiondir_FQN_list] = fn_merge_same_session_CCF_sessiondirs(sessiondir_merge_list_FQN_list)
...
%
%   sessiondir_merge_list_FQN_list : a list of paths to text file(s) listing one session
...
%  1. INPUT HANDLING
% =====================================================================
if ~exist('sessiondir_merge_list_FQN_list', 'var') || isempty(sessiondir_merge_list_FQN_list)
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2025', '251219', ...
	...
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260204', ...	% new jsonl logic
		'20260204TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260206', ...	% new jsonl logic
		'20260206TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260306', ...	% new jsonl logic
		'20260306TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260312', ...	% new jsonl logic
		'20260312TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260319', ...	% new jsonl logic
		'20260319TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260320', ...	% new jsonl logic
		'20260320TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260325', ...	% new jsonl logic
		'20260325TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260326', ...	% new jsonl logic
		'20260326TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260402', ...	% new jsonl logic
		'20260402TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260403', ...	% new jsonl logic
		'20260403TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260409', ...	% new jsonl logic
		'20260409TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};

	sessiondir_merge_list_FQN_list = { ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2025', '251219', '20251219TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...	% re-run with correct scaling
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260204', '20260204TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...		% correct scaling
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260206', '20260206TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...		% correct scaling
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260306', '20260306TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260312', '20260312TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260319', '20260319TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...	% first session with monkey gaze data...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260320', '20260320TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260325', '20260325TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260326', '20260326TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260402', '20260402TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260403', '20260403TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260409', '20260409TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260423', '20260423TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260424', '20260424TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260428', '20260428TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260429', '20260429TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260430', '20260430TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile('Y:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2026', '260501', '20260501TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		};
...
if ~iscell(sessiondir_merge_list_FQN_list)
	sessiondir_merge_list_FQN_list = {sessiondir_merge_list_FQN_list};
end
merged_sessiondir_FQN_list = {};
for i_sessiondir_merge_list_FQN = 1 : length(sessiondir_merge_list_FQN_list)
	sessiondir_merge_list_FQN = sessiondir_merge_list_FQN_list{i_sessiondir_merge_list_FQN};
	disp([mfilename, ': INFO; Processing: ', sessiondir_merge_list_FQN]);


	if ~isfile(sessiondir_merge_list_FQN)
		disp([mfilename, ': WARN: requested sessiondir_merge_list_FQN not found (skipping): ', sessiondir_merge_list_FQN]);
		continue
	end


	[cur_sessiondir_merge_list_FQN_dir, sessiondir_merge_list_FQN_name, sessiondir_merge_list_FQN_ext] = fileparts(sessiondir_merge_list_FQN);
	...
	for i_run = 1 : n_runs
		...
		% adjust to only list the path until the session dir
		if strcmp(sessiondir_merge_list_FQN_name, 'merge_TDT_TANK_dir_list') && contains(cur_sessiondir, 'TDT')
			disp([mfilename, ': converting merge_TDT_TANK_dir_list entry to merge_CCF_sessiondir_list']);
			cur_sessiondir = [extractBefore(cur_sessiondir, '.sessiondir'), '.sessiondir'];
			if strcmp(cur_sessiondir, '.sessiondir')
				error([mfilename, ': ERROR: no .sessiondir folder specified in a merge_TDT_TANK_dir_list-style cur_sessiondir...']);
			end
			sessiondir_merge_list(i_run) = {cur_sessiondir};   % <-- persist for JSONL/CSV sections
		end
	...
	for i_run = 1 : n_runs
		...
		cur_header{end+1} = 'orig_n_finished_collections';
		cur_data(:, end+1) = cur_data(:, nfc_col);
	...
	% Collect all per-run conf structs for merged_conf.jsonl
	% Build each entry with 'type' as the first field so jsonencode emits it first
	conf_list = cell(1, n_runs);
	for i_run = 1 : n_runs
		cur_conf = struct('type', 'conf');
		if isfield(raw_data_list{i_run}.json_struct, 'conf')
			orig_conf = raw_data_list{i_run}.json_struct.conf;
			orig_field_list = fieldnames(orig_conf);
			for i_f = 1 : length(orig_field_list)
				cur_conf.(orig_field_list{i_f}) = orig_conf.(orig_field_list{i_f});
			end
		end
		cur_conf.run_idx = int32(i_run - 1);
		cur_conf.source_sessiondir_FQN = raw_data_list{i_run}.source_dir_FQN;
		conf_list{i_run} = cur_conf;
	end
	merged_data_struct.conf_list = conf_list;
	...
	merged_sessiondir_FQN_list(end+1) = {merged_sessiondir_FQN};
