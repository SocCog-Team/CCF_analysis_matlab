...
if ~exist('sessiondir_merge_list_FQN_list', 'var') || isempty(sessiondir_merge_list_FQN_list)
	...
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2025', '251219', ...
		'20251219TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	%sessiondir_merge_list_FQN = {fullfile(SESSIONLOGS_dir, '2026', '260319', ...	% took 7674.839 seconds
	%	'20260319TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	%sessiondir_merge_list_FQN = {fullfile(SESSIONLOGS_dir, '2026', '260319', ...	% new jsonl logic
	%	'20260319TNNNNNNM2.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};

	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260204', ...	% new jsonl logic
		'20260204TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260206', ...	% new jsonl logic
		'20260206TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260306', ...	% new jsonl logic
		'20260306TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260312', ...	% new jsonl logic
		'20260312TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260319', ...	% new jsonl logic
		'20260319TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260320', ...	% new jsonl logic
		'20260320TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260325', ...	% new jsonl logic
		'20260325TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260326', ...	% new jsonl logic
		'20260326TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260402', ...	% new jsonl logic
		'20260402TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260403', ...	% new jsonl logic
		'20260403TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_CCF_sessiondir_list.txt')};
	sessiondir_merge_list_FQN_list = {fullfile(SESSIONLOGS_dir, '2026', '260409', ...	% new jsonl logic
	...
	sessiondir_merge_list_FQN_list = { ...
		...
		fullfile(SESSIONLOGS_dir, '2026', '260306', '20260306TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260312', '20260312TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260319', '20260319TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...	% first session with monkey gaze data...
		fullfile(SESSIONLOGS_dir, '2026', '260320', '20260320TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260325', '20260325TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260326', '20260326TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260402', '20260402TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260403', '20260403TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260409', '20260409TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260423', '20260423TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260424', '20260424TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260428', '20260428TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260429', '20260429TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
		fullfile(SESSIONLOGS_dir, '2026', '260430', '20260430TNNNNNNM.A_Elmo.B_MIXED.SCP_01.sessiondir', 'merge_TDT_TANK_dir_list.txt'), ...
